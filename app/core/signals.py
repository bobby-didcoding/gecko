...
def create_pool(sender, instance, created, **kwargs):
    if created:
        ...
        """
        network = Network.objects.get(external_id=instance.relationships["network"]["data"]["id"], type="network")
        ...
        token_pair, created = TokenPair.objects.get_or_create(base_token=base_token, quote_token=quote_token)
