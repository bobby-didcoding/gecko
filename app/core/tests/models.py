...
from core.models import Pool, Network, Dex, Token
...
class DexModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.network = Network.objects.create(external_id="base", type="network")

        self.obj = Dex.objects.create(external_id="uniswap-v3-base", type="dex", network=self.network)
...
class NetworkModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.obj = Network.objects.create(external_id="base", type="network")
...
class TokenModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.dex = Dex.objects.create(external_id="uniswap-v3-base", type="dex", network=self.network)
        ...
        self.obj = Pool.objects.create(
            ...
            attributes={
                ...
                "volume_usd": {
                    ...
                    "h6": "5410347.38290187",
                    "m5": "23944.4038803586",
                    "h24": "33934027.7244474",
                },
                "transactions": {
                    "h1": {"buys": 534, "sells": 147, "buyers": 429, "sellers": 131},
                    "m5": {"buys": 24, "sells": 9, "buyers": 22, "sellers": 8},
                    "h24": {
                        "buys": 11491,
                        "sells": 5383,
                        "buyers": 6646,
                    ...
                    "m15": {"buys": 120, "sells": 28, "buyers": 99, "sellers": 25},
                    "m30": {"buys": 261, "sells": 65, "buyers": 211, "sellers": 60},
                },
                "market_cap_usd": "287902872.856545",
                "reserve_in_usd": "11374526.3591",
                "pool_created_at": "2024-01-07T19:30:45Z",
                "base_token_price_usd": "0.0231121473908398",
                "quote_token_price_usd": "3496.61",
                ...
                "base_token_price_quote_token": "0.00000661",
                "quote_token_price_base_token": "151292",
                "base_token_price_native_currency": "0.00000660971320317256",
                "quote_token_price_native_currency": "1.0",
            },
            relationships={
                "dex": {"data": {"id": "uniswap-v3-base", "type": "dex"}},
                "network": {"data": {"id": "base", "type": "network"}},
                "base_token": {
                    "data": {
